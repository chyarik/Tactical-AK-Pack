...
class CfgWorlds
{
  ...
  //A1 style: groupNameFormat = "%GroupSquad-%GroupPlatoon-%GroupCompany";
  ...
  class GroupSquad
  {
    ...
    class Squad3
    {
      name = $STR_A3_CfgWorlds_GroupSquad_Squad30;
		...
		class Squad4
		{
			name = $STR_A3_CfgWorlds_GroupSquad_Squad40;
		};
		class Squad5
		{
			name = $STR_A3_CfgWorlds_GroupSquad_Squad50;
		};
		class Squad6
		{
			name = $STR_A3_CfgWorlds_GroupSquad_Squad60;
		};
  };
  class GroupPlatoon
  {
  ...
  {
    access = ReadAndWrite;
    class Default // default naming scheme for non-persons (logics)
    {
      class FirstNames
      {
        default = "Unknown";
